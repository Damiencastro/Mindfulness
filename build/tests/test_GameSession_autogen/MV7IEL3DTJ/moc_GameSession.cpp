...
void GameSession::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->sessionFinished(); break;
        case 1: _t->onTimeSet((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->updateTimer(); break;
        case 3: _t->showWarning(); break;
        case 4: _t->onWarningDialogClosed(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameSession::*)()>(_a, &GameSession::sessionFinished, 0))
            return;
    }
}
...
// SIGNAL 0
void GameSession::sessionFinished()
{
